...
public abstract class AsynchronousAssetLoader<T, P extends AssetLoaderParameters<T>> extends AssetLoader<T, P> {
	...
	public AsynchronousAssetLoader(String assetsDir) {
		super(assetsDir);
	}
	 ...
	 */
	public abstract void loadAsync(AssetManager manager, String fileName, String fileLoc, P parameter);
	 ...
	 * @param parameter
	 */
	public abstract T loadSync(AssetManager manager, String fileName, String fileLoc, P parameter);
}
