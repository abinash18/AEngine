...
import net.abi.abisEngine.rendering.shader.Shader.ShaderSource;
import net.abi.abisEngine.rendering.shader.compiler.fileTypes.yaml.AEShaderFileYAML;
import net.abi.abisEngine.rendering.shader.compiler.fileTypes.yaml.AEShaderGLSLProgram;
import net.abi.abisEngine.rendering.shader.compiler.loader.AEShaderLoader;
import net.abi.abisEngine.rendering.shader.compiler.loader.AEShaderLoader.ShaderType;
...
public class AEShaderCompiler {
	...
	private String processImport(String programName, String fileName) {
		...
		if ((gp = loadedImports.get(fileName + AE_SHADER_FILE_TYPE, programName)) == null) {
			// System.out.println("Looking for : " + fileName + AE_SHADER_FILE_TYPE + " " +
			// programName);
			/*
